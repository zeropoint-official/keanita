...
const TOPICS: Topic[] = [
  { icon: 'leaf.fill', color: '#6BBF6A', bg: '#EEFBEE', title: 'Υγιεινή διατροφή', body: 'Βιωματικά εργαστήρια για ισορροπημένη διατροφή, λιχουδιές από αληθινά φρούτα και συνήθειες για δραστήρια παιδιά.' },
  { icon: 'sparkles', color: '#F5A623', bg: '#FFF6E8', title: 'Δημιουργικό παιχνίδι', body: 'Μαγειρική, ζωγραφική και δραστηριότητες στη φάρμα — για περίεργα παιδιά 5–11 ετών.' },
  { icon: 'person.2.fill', color: '#5DADE2', bg: '#EDF7FD', title: 'Και για γονείς', body: 'Ανοιχτές συναντήσεις με ειδικούς για το πώς μεγαλώνουμε καλόκαρδα, γεμάτα ενέργεια και αυτοπεποίθηση παιδιά.' },
];
...
export default function SeminarsScreen() {
  ...
  const stats = [
    { value: seminars.length.toString(), label: 'Επερχόμενα', color: '#6BBF6A' },
    { value: '3', label: 'Θεματικές', color: '#5DADE2' },
    { value: '12+', label: 'Πόλεις', color: '#F5A623' },
  ];
  ...
  return (
    <View style={{ backgroundColor: '#FAFAF7', minHeight: '100dvh', paddingBottom: 96 }}>
      ...
      <LinearGradient colors={['#6BBF6A', '#5DADE2']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={{ borderBottomLeftRadius: 32, borderBottomRightRadius: 32 }}>
        <AppHeader transparent tint="light" title="Σεμινάρια" showBrand={false} />
        <View style={{ paddingLeft: 24, paddingRight: 24, paddingBottom: 40, paddingTop: 4 }}>
          <View style={{ alignSelf: 'flex-start', borderRadius: 999, paddingLeft: 12, paddingRight: 12, paddingTop: 4, paddingBottom: 4, marginBottom: 12, backgroundColor: 'rgba(255,255,255,0.22)' }}>
            <Text style={{ ...Fonts.bodyBold, color: '#FFFFFF', fontSize: 11, textTransform: 'uppercase', letterSpacing: 1 }}>Μάθε · Μεγάλωσε · Παίξε</Text>
          </View>
          <Text style={{ ...Fonts.displayHeavy, color: '#FFFFFF', fontSize: 28, lineHeight: '34px' }}>Σεμινάρια &amp; εκδηλώσεις για όλη την οικογένεια</Text>
          <Text style={{ ...Fonts.bodySemiBold, color: 'rgba(255,255,255,0.85)', fontSize: 14, marginTop: 12, lineHeight: '20px' }}>
            Βιωματικά εργαστήρια, ημέρες διασκέδασης και ανοιχτές ομιλίες — όλα τα καλά σε ένα μέρος.
          </Text>
        </View>
      </LinearGradient>
      ...
      {/* Topics */}
      <Text style={{ ...Fonts.displayMedium, fontSize: 18, color: '#2D2D3A', marginLeft: 24, marginRight: 24, marginTop: 28, marginBottom: 12 }}>Τι καλύπτουμε</Text>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginLeft: 24, marginRight: 24, marginTop: 28, marginBottom: 12 }}>
        <Text style={{ ...Fonts.displayMedium, fontSize: 18, color: '#2D2D3A' }}>Επερχόμενα σεμινάρια</Text>
        <Text style={{ ...Fonts.bodySemiBold, fontSize: 12, color: '#6BBF6A' }}>Δες όλα</Text>
      </View>
      ...
      {seminars.length === 0 ? (
        <View style={{ marginLeft: 24, marginRight: 24, alignItems: 'center', paddingTop: 40, paddingBottom: 40, backgroundColor: '#FFFFFF', borderRadius: 16 }}>
          <Text style={{ ...Fonts.body, fontSize: 14, color: '#B8B8C4' }}>Δεν υπάρχουν προγραμματισμένα σεμινάρια — έλεγξε ξανά σύντομα!</Text>
        </View>
      ) : (
      ...
      {otherEvents.length > 0 && (
        <>
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginLeft: 24, marginRight: 24, marginTop: 16, marginBottom: 12 }}>
            <Text style={{ ...Fonts.displayMedium, fontSize: 18, color: '#2D2D3A' }}>Ίσως σου αρέσουν</Text>
            <Text onClick={() => router.push('/events')} style={{ ...Fonts.bodySemiBold, fontSize: 12, color: '#F5A623', cursor: 'pointer' }}>Όλες οι εκδηλώσεις</Text>
          </View>
      ...
      <View style={{ marginLeft: 24, marginRight: 24, marginTop: 12 }}>
        <LinearGradient colors={['#9B7FD4', '#5DADE2']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={{ borderRadius: 26, padding: 20 }}>
          <Text style={{ ...Fonts.displayHeavy, color: '#FFFFFF', fontSize: 16 }}>Μη χάσεις το επόμενο</Text>
          <Text style={{ ...Fonts.bodySemiBold, color: 'rgba(255,255,255,0.85)', fontSize: 12, marginTop: 4, lineHeight: '20px' }}>
            Γράψου στο newsletter μας και θα σου στέλνουμε νέα για σεμινάρια και εκδηλώσεις.
          </Text>
          <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 12 }}>
            <View style={{ borderRadius: 12, paddingLeft: 12, paddingRight: 12, paddingTop: 8, paddingBottom: 8, backgroundColor: 'rgba(255,255,255,0.9)' }}>
              <Text style={{ ...Fonts.bodyHeavy, fontSize: 12, color: '#5D3FA8' }}>Εγγραφή →</Text>
            </View>
          </View>
        </LinearGradient>
      </View>
